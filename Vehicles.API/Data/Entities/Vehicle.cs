...
namespace Vehicles.API.Data.Entities
{
    public class Vehicle
    {
        ...
        [Display(Name = "Foto")]
        public string ImageFullPath => VehiclePhotos == null || VehiclePhotos.Count == 0              //Contador de cuantas fotos estan registradas del vehiculo
        ...
        public int HistoriesCount => Histories == null ? 0 : Histories.Count;                         //Contador de cuantas historias tiene el vehiculo
    }
}

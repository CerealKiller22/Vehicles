...
namespace Vehicles.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()    //Metodo para alimentar la base de datos
        {
            await _context.Database.EnsureCreatedAsync();
            await CheckVehiclesTypesAsync();
            await CheckBrandsAsync();
            await CheckDocumentTypesAsync();
            await CheckBProceduresAsync();
        ...
        private async Task CheckUserAsync(string document, string firstName, string lastName, string email, string phoneNumber, string address, UserType userType)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.ConfirmEmailAsync(user, token);    //Confirma un usuario por debajo del sistema
            }
        }
        ...
        private async Task CheckBProceduresAsync()
        {
        ...
        private async Task CheckDocumentTypesAsync()
        {
            if (!_context.DocumentTypes.Any())
            {
                ...
                _context.DocumentTypes.Add(new DocumentType { Description = "Tajeta de identidad" });
